...
public class Column implements java.io.Serializable,Cloneable{
	...
	/**
	 * The name of the column_table
	 */
	private String _fkTableSql;
	...
	public Column(Table table, int sqlType, String sqlTypeName,
			String sqlName, String fkTableSql, int size, int decimalDigits, boolean isPk,
		    boolean isFk, boolean isNullable, boolean isIndexed, boolean isUnique,
...
//			_table.getExportedKeys().addForeignKey(refTable.getSqlName(), hasMany.columnSqlName, getSqlName(), hasMany.columnSqlName.toLowerCase().hashCode());
	...
	private void initOtherProperties() {
		...
		fkTableName = StringHelper.makeAllWordFirstLetterUpperCase(StringHelper.toUnderscoreName(getFkTableSql()));
