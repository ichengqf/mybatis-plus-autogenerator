...
import static cn.org.rapid_framework.generator.provider.db.table.model.Table.removeTableSqlNamePrefix;
...
public class ForeignKey implements java.io.Serializable{
	...
	protected String parentColumnClassName;
	
	public ForeignKey(Table aTable, String tblName, String parentColumn) {
		super();
		parentTable = aTable;
		tableName   = tblName;
		...
		//根据表名或者字段名得到的类名称，示例值: user_info --> UserInfo
		String removedPrefixSqlName = removeTableSqlNamePrefix(parentColumn);
		this.parentColumnClassName = StringHelper.makeAllWordFirstLetterUpperCase(StringHelper.toUnderscoreName(removedPrefixSqlName));
	}
	...
	public String getParentColumnClassName() {
		return parentColumnClassName;
	}
